...
export default function index() {
  ...
  const getDataByMonth = async (month) => {
    setLoading(true);
    const response = await getAllDetailTransaksiByMonth(month);
    setDataMenu(response.data);
    setTotalPendapatan(response.total_keseluruhan);
    setLoading(false);
  };
  ...
  const getDataByDate = async (date) => {
    setLoading(true);
    const response = await getAllDetailTransaksiByDate(date);
    setDataMenu(response.data);
    setTotalPendapatan(response.total_keseluruhan);
    setLoading(false);
  };
