...
export default function index() {
  ...
  const getTransaksi = async () => {
    ...
    const responseDetailTransaksi = await getDetailTransaksiByIdTransaksi(id);
    setTransaksi(response.data);
    setKolomMenu(responseDetailTransaksi.data);
  };
  ...
  const submitHandlerTransaksi = async (values) => {
    ...
    const response = await updateTransaksi(id, value);
